...
This repository is a template for a Drupal Forge app that creates an existing
project with Composer, then performs a clean Drupal install with a default
admin password of _admin_. __If you want to use Drupal Forge to create a new
project, you do not need to start with this template.__ The Composer project to
create is specified by the `PROJECT` environment variable. If `PROJECT` is not
